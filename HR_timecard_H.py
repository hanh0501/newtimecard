...
def input_reason_leave_early():
    try:
        Waits.Wait10s_ElementLoaded(data["TIMECARD"]["leave_early"])
...
#------------------------------------------------------------------------------------------#
    ...
    hour_number1 = int(office_time.text.split("H")[0])
    ...
    working_number1 = int(working_time.text.split("H")[0])
    ...
    break_number1 = int(break_time.text.split("H")[0])
    ...
    OT_number1 = int(OT_time.text.split("H")[0])
...
def weekly_status2():
    try:
        ...
        try:
            ...
            hour_number_thursday_time2 = int(thursday_time2.split(" ")[0].split("H")[0])
            ...
            Logging(thursday_time_decimal2)
            Logging("thursday after change to decimal: " + str(round(thursday_time_decimal2, 2)))
        except:
            thursday_time_decimal2 = int(thursday_time2.split(" ")[0].split("H")[0])
            Logging("thursday after change to decimal: " + str(thursday_time_decimal2))
        ...
        try:
            ...
            Logging(saturday_time_decimal2)
...
def company_timecard_reports():
    try:
        ...
        working_day_number = int(working_day.text.split(" ")[0])
        ...
        worked_day_number = int(worked_day.text.split(" ")[0])
        ...
        try:
            avg_worked_time_per_day_minute_number = int(avg_worked_time_per_day_time.split(" ")[1].split("m")[0]) 
            avg_worked_time_per_day_hour_number = int(avg_worked_time_per_day_time.split(" ")[0].split("H")[0])
            ...
            avg_worked_time_per_day_decimal = int(avg_worked_time_per_day_time.split(" ")[0].split("H")[0])
            Logging("Avg.Worked time per day after change to decimal: " + str(avg_worked_time_per_day_decimal))
        ...
        try:
            avg_worked_time_per_week_minute_number = int(avg_worked_time_per_week_time.split(" ")[1].split("m")[0])
            avg_worked_time_per_week_hour_number = int(avg_worked_time_per_week_time.split(" ")[0].split("H")[0])
    ...
    try:
        ...
        working_day_number1 = int(scheduled_workingday.text.split(" ")[0])
        ...
        worked_day_number1 = int(scheduled_worked_day.text.split(" ")[0])
        ...
        holiday_number1 = int(holiday.text.split(" ")[0])
        ...
        day_off_number1 = int(day_off.text.split(" ")[0])
        ...
        scheduled_working_vacation_number1 = int(scheduled_working_vacation.text.split(" ")[0])
    ...
    try:
        ...
        try:
            avg_working_time_per_day_minute_number = int(avg_working_time_per_day_time.split(" ")[1].split("m")[0])
            avg_working_time_per_day_hour_number = int(avg_working_time_per_day_time.split(" ")[0].split("H")[0])
        ...
        try:
            avg_working_time_per_week_minute_number = int(avg_working_time_per_week_time.split(" ")[1].split("m")[0])
            avg_working_time_per_week_hour_number = int(avg_working_time_per_week_time.split(" ")[0].split("H")[0])
            ...
            avg_working_time_per_week_decimal = int(avg_working_time_per_week_time.split(" ")[0].split("H")[0])
            Logging("Avg.Working time per week after change to decimal: " + str(avg_working_time_per_week_decimal))
            TesCase_LogResult(**data["testcase_result"]["HR-Timecard"]["monthly_working_status"]["pass"])
    ...
    try:
        ...
        events_clockin_decimal = int(events_clockin.text.split(" ")[0])
        ...
        tardiness_decimal = int(tardiness.text.split(" ")[0])
        ...
        no_clockin_decimal = int(no_clockin.text.split(" ")[0])
        ...
        events_clockout_decimal = int(events_clockout.text.split(" ")[0])
        ...
        leave_early_decimal = int(leave_early.text.split(" ")[0])
        ...
        no_clockout_decimal = int(no_clockout.text.split(" ")[0])
        ...
        events_OT_decimal = int(events_OT.text.split(" ")[0])
        ...
        night_shift_decimal = int(night_shift.text.split(" ")[0])
        ...
        vacation_decimal = int(vacation.text.split(" ")[0])
    ...
    try:
        ...
        list_clockin_decimal = int(list_clockin.text.split(" ")[0])
        ...
        list_tardiness_decimal = int(list_tardiness.text.split(" ")[0])
        ...
        list_no_clockin_decimal = int(list_no_clockin.text.split(" ")[0])
        ...
        list_clockout_decimal = int(list_clockout.text.split(" ")[0])
        ...
        list_leave_early_decimal = int(list_leave_early.text.split(" ")[0])
        ...
        list_no_clockout_decimal = int(list_no_clockout.text.split(" ")[0])
        ...
        list_OT_decimal = int(list_OT.text.split(" ")[0])
        ...
        list_night_shift_decimal = int(list_night_shift.text.split(" ")[0])
        ...
        list_vacation_decimal = int(list_vacation.text.split(" ")[0])
    ...
    try:
        ...
        settlement_holiday_decimal = int(settlement_holiday.text.split(" ")[0])
        ...
        settlement_day_off_decimal = int(settlement_day_off.text.split(" ")[0])
        ...
        settlement_vacation_decimal = int(settlement_vacation.text.split(" ")[0])
...
def work_place():
    ...
    try:
        ...
        if holiday_noti.text == "Data saved successfully.":
            PrintGreen(">>>Add work holiday successfully")
        elif holiday_noti.text == "There is duplicated data, please try again":
            Logging("Duplicated data is available")
...
def report_weekly():
    ...
    try:
        ...
        try:
            minutes_number_workingtime_1 = int(workingtime_1.split(" ")[1].split("m")[0])
            #Logging(minutes_number_workingtime_1)
            hour_number_workingtime_1 = int(workingtime_1.split(" ")[0].split("H")[0])
            ...
            workingtime_decimal1 = int(workingtime_1.split(" ")[0].split("H")[0])
        ...
        try:
            ...
            minutes_number_breaktime_1 = int(breaktime_1.split(" ")[1].split("m")[0])
            #Logging(minutes_number_breaktime_1)
            hour_number_breaktime_1 = int(breaktime_1.split(" ")[0].split("H")[0])
            ...
            breaktime_decimal1 = int(breaktime_1.split(" ")[0].split("H")[0])
        ...
        try:
            minutes_number_OTtime_1 = int(OTtime_1.split(" ")[1].split("m")[0])
            #Logging(minutes_number_OTtime_1)
            hour_number_OTtime_1 = int(OTtime_1.split(" ")[0].split("H")[0])
            ...
            OTtime_decimal1 = int(OTtime_1.split(" ")[0].split("H")[0])
        ...
        try:
            minutes_number_total_working_hour_time_1 = int(total_working_hour_time_1.split(" ")[1].split("m")[0])
            #Logging(minutes_number_total_working_hour_time_1)
            hour_number_total_working_hour_time_1 = int(total_working_hour_time_1.split(" ")[0].split("H")[0])
            ...
            total_working_hour_time_decimal1 = int(total_working_hour_time_1.split(" ")[0].split("H")[0])
    ...
    try:
        ...
        try:
            minutes_number_workingtime_2 = int(workingtime_2.split(" ")[1].split("m")[0])
            #Logging(minutes_number_workingtime_2)
            hour_number_workingtime_2 = int(workingtime_2.split(" ")[0].split("H")[0])
            ...
            workingtime_decimal2 = int(workingtime_2.split(" ")[0].split("H")[0])
        ...
        try:
            minutes_number_breaktime_2 = int(breaktime_2.split(" ")[1].split("m")[0])
            #Logging(minutes_number_breaktime_2)
            hour_number_breaktime_2 = int(breaktime_2.split(" ")[0].split("H")[0])
            ...
            breaktime_decimal2 = int(breaktime_2.split(" ")[0].split("H")[0])
        ...
        try:
            minutes_number_OTtime_2 = int(OTtime_2.split(" ")[1].split("m")[0])
            #Logging(minutes_number_OTtime_2)
            hour_number_OTtime_2 = int(OTtime_2.split(" ")[0].split("H")[0])
            ...
            OTtime_decimal2 = int(OTtime_2.split(" ")[0].split("H")[0])
        ...
        try:
            minutes_number_total_working_hour_time_2 = int(total_working_hour_time_2.split(" ")[1].split("m")[0])
            #Logging(minutes_number_total_working_hour_time_2)
            hour_number_total_working_hour_time_2 = int(total_working_hour_time_2.split(" ")[0].split("H")[0])
            ...
            total_working_hour_time_decimal2 = int(total_working_hour_time_2.split(" ")[0].split("H")[0])
    ...
    try:
        ...
        try:
            minutes_number_workingtime_3 = int(workingtime_3.split(" ")[1].split("m")[0])
            #Logging(minutes_number_workingtime_3)
            hour_number_workingtime_3 = int(workingtime_3.split(" ")[0].split("H")[0])
            ...
            workingtime_decimal3 = int(workingtime_3.split(" ")[0].split("H")[0])
        ...
        try:
            minutes_number_breaktime_3 = int(breaktime_3.split(" ")[1].split("m")[0])
            #Logging(minutes_number_breaktime_3)
            hour_number_breaktime_3 = int(breaktime_3.split(" ")[0].split("H")[0])
            ...
            breaktime_decimal3 = int(breaktime_3.split(" ")[0].split("H")[0])
        ...
        try:
            minutes_number_OTtime_3 = int(OTtime_3.split(" ")[1].split("m")[0])
            #Logging(minutes_number_OTtime_3)
            hour_number_OTtime_3 = int(OTtime_3.split(" ")[0].split("H")[0])
            ...
            OTtime_decimal3 = int(OTtime_3.split(" ")[0].split("H")[0])
        ...
        try:
            minutes_number_total_working_hour_time_3 = int(total_working_hour_time_3.split(" ")[1].split("m")[0])
            #Logging(minutes_number_total_working_hour_time_3)
            hour_number_total_working_hour_time_3 = int(total_working_hour_time_3.split(" ")[0].split("H")[0])
            ...
            total_working_hour_time_decimal3 = int(total_working_hour_time_3.split(" ")[0].split("H")[0])
    ...
    try:
        ...
        try:
            minutes_number_workingtime_4 = int(workingtime_4.split(" ")[1].split("m")[0])
            #Logging(minutes_number_workingtime_4)
            hour_number_workingtime_4 = int(workingtime_4.split(" ")[0].split("H")[0])
            ...
            workingtime_decimal4 = int(workingtime_4.split(" ")[0].split("H")[0])
        ...
        try:
            minutes_number_breaktime_4 = int(breaktime_4.split(" ")[1].split("m")[0])
            #Logging(minutes_number_breaktime_4)
            hour_number_breaktime_4 = int(breaktime_4.split(" ")[0].split("H")[0])
            ...
            breaktime_decimal4 = int(breaktime_4.split(" ")[0].split("H")[0])
        ...
        try:
            minutes_number_OTtime_4 = int(OTtime_4.split(" ")[1].split("m")[0])
            #Logging(minutes_number_OTtime_4)
            hour_number_OTtime_4 = int(OTtime_4.split(" ")[0].split("H")[0])
            ...
            OTtime_decimal4 = int(OTtime_4.split(" ")[0].split("H")[0])
        ...
        try:
            minutes_number_total_working_hour_time_4 = int(total_working_hour_time_4.split(" ")[1].split("m")[0])
            #Logging(minutes_number_total_working_hour_time_4)
            hour_number_total_working_hour_time_4 = int(total_working_hour_time_4.split(" ")[0].split("H")[0])
            ...
            total_working_hour_time_decimal4 = int(total_working_hour_time_4.split(" ")[0].split("H")[0])
    ...
    try:
        ...
        try:
            minutes_number_workingtime_5 = int(workingtime_5.split(" ")[1].split("m")[0])
            #Logging(minutes_number_workingtime_5)
            hour_number_workingtime_5 = int(workingtime_5.split(" ")[0].split("H")[0])
            ...
            workingtime_decimal5 = int(workingtime_5.split(" ")[0].split("H")[0])
        ...
        try:
            minutes_number_breaktime_5 = int(breaktime_5.split(" ")[1].split("m")[0])
            #Logging(minutes_number_breaktime_5)
            hour_number_breaktime_5 = int(breaktime_5.split(" ")[0].split("H")[0])
            ...
            breaktime_decimal5 = int(breaktime_5.split(" ")[0].split("H")[0])
        ...
        try:
            minutes_number_OTtime_5 = int(OTtime_5.split(" ")[1].split("m")[0])
            #Logging(minutes_number_OTtime_5)
            hour_number_OTtime_5 = int(OTtime_5.split(" ")[0].split("H")[0])
            ...
            OTtime_decimal5 = int(OTtime_5.split(" ")[0].split("H")[0])
        ...
        try:
            minutes_number_total_working_hour_time_5 = int(total_working_hour_time_5.split(" ")[1].split("m")[0])
            #Logging(minutes_number_total_working_hour_time_5)
            hour_number_total_working_hour_time_5 = int(total_working_hour_time_5.split(" ")[0].split("H")[0])
            ...
            total_working_hour_time_decimal5 = int(total_working_hour_time_5.split(" ")[0].split("H")[0])
    ...
    try:
        ...
        try:
            minutes_number_workingtime_6 = int(workingtime_6.split(" ")[1].split("m")[0])
            #Logging(minutes_number_workingtime_6)
            hour_number_workingtime_6 = int(workingtime_6.split(" ")[0].split("H")[0])
            ...
            workingtime_decimal6 = int(workingtime_6.split(" ")[0].split("H")[0])
        ...
        try:
            minutes_number_breaktime_6 = int(breaktime_6.split(" ")[1].split("m")[0])
            #Logging(minutes_number_breaktime_6)
            hour_number_breaktime_6 = int(breaktime_6.split(" ")[0].split("H")[0])
            ...
            breaktime_decimal6 = int(breaktime_6.split(" ")[0].split("H")[0])
        ...
        try:
            minutes_number_OTtime_6 = int(OTtime_6.split(" ")[1].split("m")[0])
            #Logging(minutes_number_OTtime_6)
            hour_number_OTtime_6 = int(OTtime_6.split(" ")[0].split("H")[0])
            ...
            OTtime_decimal6 = int(OTtime_6.split(" ")[0].split("H")[0])
        ...
        try:
            minutes_number_total_working_hour_time_6 = int(total_working_hour_time_6.split(" ")[1].split("m")[0])
            #Logging(minutes_number_total_working_hour_time_6)
            hour_number_total_working_hour_time_6 = int(total_working_hour_time_6.split(" ")[0].split("H")[0])
            ...
            total_working_hour_time_decimal6 = int(total_working_hour_time_6.split(" ")[0].split("H")[0])
...
def approval_my_request():
    ...
    try:
        filters_type = Commands.ClickElement(data["TIMECARD"]["filters_type"])
        time.sleep(3)
...
def dashboard():
    try:
        ...
        today_work1 = dashboard_work_place.text.split(" ")[0]
        Logging("Work Place - Country : " + today_work1)

        today_work_timezone1 = dashboard_work_place.text.split(" ")[1]
        ...
        dashboard_remaining_working_time2_decimal = int(dashboard_remaining_working_time.text.split("H")[0] )
        ...
        dashboard_working_time2_decimal = int(dashboard_working_time.text.split("H")[0] )
        ...
        dashboard_break_time2_decimal = int(dashboard_break_time.text.split("H")[0] )
        ...
        dashboard_OT_time2_decimal = int(dashboard_OT_time.text.split("H")[0] )
    ...
    try:
        ...
        dashboard_remaining_working_time_after2_decimal = int(dashboard_remaining_working_time_after.text.split("H")[0] )
        ...
        dashboard_working_time_after2_decimal = int(dashboard_working_time_after.text.split("H")[0] )
        ...
        dashboard_break_time_after2_decimal = int(dashboard_break_time_after.text.split("H")[0] )
        ...
        dashboard_OT_time_after2_decimal = int(dashboard_OT_time_after.text.split("H")[0] )
        ...
        avatar_work1 = avatar_work_place_timezone.text.split("(")[0]
    ...
    try:
        ...
        total_number3 = int(total3.text.split("H")[0])
        ...
        OT_number = int(OT2.text.split("H")[0])
        ...
        reports_night_shift_number = int(reports_night_shift.text.split("H")[0])
        ...
        WWT_working_time_time_number = int(WWT_working_time.text.split("H")[0])
        ...
        WWT_OT_time_number = int(WWT_OT.text.split("H")[0])
        ...
        WWT_night_shift_time_number = int(WWT_night_shift.text.split("H")[0])
    ...
    try:
        ...
        TCS_clockin_time_number = int(TCS_clockin.text.split(" ")[0])
        ...
        TCS_tardiness_time_number = int(TCS_tardiness.text.split(" ")[0])
        ...
        TCS_no_clockin_time_number = int(TCS_no_clockin.text.split(" ")[0])
        ...
        TCS_clockout_time_number = int(TCS_clockout.text.split(" ")[0])
        ...
        TCS_leave_early_time_number = int(TCS_leave_early.text.split(" ")[0])
        ...
        TCS_vacation_time_number = int(TCS_vacation.text.split(" ")[0])
        ...
        events_clockin_decimal1 = int(events_clockin1.text.split(" ")[0])
        ...
        tardiness_decimal1 = int(tardiness1.text.split(" ")[0])
        ...
        no_clockin_decimal1 = int(no_clockin1.text.split(" ")[0])
        ...
        events_clockout_decimal1 = int(events_clockout1.text.split(" ")[0])
        ...
        leave_early_decimal1 = int(leave_early1.text.split(" ")[0])
        ...
        vacation_decimal1 = int(vacation1.text.split(" ")[0])
    ...
    try:
        ...
        WD_worked_days_decimal = int(WD_worked_days.text.split(" ")[0])
        ...
        WD_scheduled_working_days_decimal = int(WD_scheduled_working_days.text.split(" ")[0])
        ...
        WD_remaining_working_days_decimal = int(WD_remaining_working_days.text.split(" ")[0])
        ...
        try:
            hour_number_worked_time_mywork = int(worked_time_mywork1.split(" ")[0].split("H")[0])
            #Logging(hour_number_worked_time_mywork)
            minutes_number_worked_time_mywork = int(worked_time_mywork1.split(" ")[1].split("M")[0])
            ...
            worked_time_mywork_decimal = int(worked_time_mywork1.split(" ")[0].split("H")[0])
            Logging("Worked time after change to decimal: " + str(worked_time_mywork_decimal))
        ...
        try:
            hour_number_remaining_working_time_mywork = int(remaining_working_time_mywork1.split(" ")[0].split("H")[0])
            #Logging(hour_number_remaining_working_time_mywork)
            minutes_number_remaining_working_time_mywork = int(remaining_working_time_mywork1.split(" ")[1].split("M")[0])
            ...
            remaining_working_time_mywork_decimal = int(remaining_working_time_mywork1.split(" ")[0].split("H")[0])
            Logging("Remaining working time after change to decimal: " + str(remaining_working_time_mywork_decimal))
        ...
        try:
            hour_scheduled_working_time_mywork = int(scheduled_working_time_mywork1.split(" ")[0].split("H")[0])
            #Logging(scheduled_working_time_mywork)
            minutes_number_scheduled_working_time_mywork = int(scheduled_working_time_mywork1.split(" ")[1].split("M")[0])
            ...
            scheduled_working_time_mywork_decimal = int(scheduled_working_time_mywork1.split(" ")[0].split("H")[0])
            Logging("Scheduled working time after change to decimal: " + str(scheduled_working_time_mywork_decimal))
            TesCase_LogResult(**data["testcase_result"]["HR-Timecard"]["user_mywork_workingtime"]["pass"])
        ...
        try:
            hour_number_worked_time_settlement = int(worked_time_settlement1.split(" ")[0].split("H")[0])
            #Logging(hour_number_worked_time_settlement)
            minutes_number_worked_time_settlement = int(worked_time_settlement1.split(" ")[1].split("M")[0])
            ...
            worked_time_settlement_decimal = int(worked_time_settlement1.split(" ")[0].split("H")[0])
            Logging("Working time after change to decimal: " + str(worked_time_settlement_decimal))
        ...
        try:
            hour_number_OT_settlement = int(OT_settlement1.split(" ")[0].split("H")[0])
            #Logging(hour_number_OT_settlement)
            minutes_number_OT_settlement = int(OT_settlement1.split(" ")[1].split("M")[0])
            ...
            OT_settlement_decimal = int(OT_settlement1.split(" ")[0].split("H")[0])
        ...
        try:
            hour_number_nightshift_settlement = int(nightshift_settlement1.split(" ")[0].split("H")[0])
            #Logging(hour_number_nightshift_settlement)
            minutes_nightshift_settlement1 = int(nightshift_settlement1.split(" ")[1].split("M")[0])
            #Logging(minutes_OT_settlement)
            ...
            nightshift_settlement_decimal = int(nightshift_settlement1.split(" ")[0].split("H")[0])
        ...
        try:
            hour_number_holiday_work_settlement = int(holiday_work_settlement1.split(" ")[0].split("H")[0])
            #Logging(hour_number_holiday_work_settlement)
            minutes_holiday_work_settlement = int(holiday_work_settlement.split(" ")[1].split("M")[0])
            #Logging(minutes_OT_settlement)
            ...
            holiday_work_settlement_decimal = int(holiday_work_settlement1.split(" ")[0].split("H")[0])
        ...
        holiday_settlement_decimal = int(holiday_settlement.text.split(" ")[0])
        ...
        day_off_settlement_decimal = int(day_off_settlement.text.split(" ")[0])
        ...
        vacation_settlement_decimal = int(vacation_settlement.text.split(" ")[0])
        ...
        WD_cumulative_days_decimal = int(WD_cumulative_days.text.split(" ")[0])
        ...
        WD_contractual_working_days_decimal = int(WD_contractual_working_days.text.split(" ")[0])
        ...
        schedules_remaining_working_days_decimal = int(schedules_remaining_working_days.text.split(" ")[0])
        ...
        try:
            hour_number_worked_time_schedules = int(worked_time_schedules1.split(" ")[0].split("H")[0])
            #Logging(hour_number_worked_time_schedules)
            minutes_number_worked_time_schedules = int(worked_time_schedules1.split(" ")[1].split("M")[0])
            ...
            worked_time_schedules_decimal = int(worked_time_schedules1.split(" ")[0].split("H")[0])
            Logging("Worked time after change to decimal: " + str(worked_time_schedules_decimal))
        ...
        try:
            hour_number_remaining_working_time_schedules = int(remaining_working_time_schedules1.split(" ")[0].split("H")[0])
            #Logging(hour_number_remaining_working_time_schedules)
            minutes_number_remaining_working_time_schedules = int(remaining_working_time_schedules1.split(" ")[1].split("M")[0])
            ...
            remaining_working_time_schedules_decimal = int(remaining_working_time_schedules1.split(" ")[0].split("H")[0])
            Logging("Remaining working time after change to decimal: " + str(remaining_working_time_schedules_decimal))
        ...
        try:
            hour_number_scheduled_working_time_schedules = int(scheduled_working_time_schedules1.split(" ")[0].split("H")[0])
            #Logging(hour_number_scheduled_working_time_schedules)
            minutes_OT_settlement = int(OT_settlement1.split(" ")[1].split("M")[0])
            #Logging(minutes_OT_settlement)
        ...
        try:
            schedules_hour_number_working_time_settlement = int(schedules_working_time_settlement1.split(" ")[0].split("H")[0])
            #Logging(schedules_hour_number_working_time_settlement)
            schedules_minutes_number_working_time_settlement = int(schedules_working_time_settlement1.split(" ")[1].split("M")[0])
            ...
            schedules_working_time_settlement_decimal = int(schedules_working_time_settlement1.split(" ")[0].split("H")[0])
            Logging("Working time after change to decimal: " + str(schedules_working_time_settlement_decimal))
        ...
        try:
            schedules_hour_number_OT_settlement = int(schedules_OT_settlement1.split(" ")[0].split("H")[0])
            #Logging(schedules_hour_number_OT_settlement)
            minutes_number_OT_settlement1 = int(schedules_OT_settlement1.split(" ")[1].split("M")[0])
            #Logging(minutes_number_worked_time_mywork)
            ...
            schedules_OT_settlement_decimal = int(schedules_OT_settlement1.split(" ")[0].split("H")[0])
        ...
        try:
            schedules_hour_number_holiday_work_settlement = int(schedules_holiday_work_settlement1.split(" ")[0].split("H")[0])
            #Logging(schedules_hour_number_holiday_work_settlement)
            minutes_number_holiday_work_settlement1 = int(schedules_holiday_work_settlement1.split(" ")[1].split("M")[0])
            #Logging(minutes_number_worked_time_mywork)
            schedules_holiday_work_settlement_decimal = ((minutes_number_holiday_work_settlement1) / 60) + (schedules_hour_number_holiday_work_settlement)
            Logging("Worked time after change to decimal: " + str(schedules_holiday_work_settlement_decimal))
        except:
            schedules_holiday_work_settlement_decimal = int(schedules_holiday_work_settlement1.split(" ")[0].split("H")[0])
        ...
        schedules_holiday_settlement_decimal = int(schedules_holiday_settlement.text.split(" ")[0])
        ...
        schedules_day_off_settlement_decimal = int(schedules_day_off_settlement.text.split(" ")[0])
        ...
        schedules_vacation_settlement_decimal = int(schedules_vacation_settlement.text.split(" ")[0])
    ...
    try:
        ...
        TCS_clock_in_number = int(TCS_clock_in.text.split(" ")[0])
        ...
        TCS_tardiness_number = int(TCS_tardiness.text.split(" ")[0])
        ...
        TCS_no_clock_in_number = int(TCS_no_clock_in.text.split(" ")[0])
        ...
        TCS_clock_out_number = int(TCS_clock_out.text.split(" ")[0])
        ...
        TCS_leave_early_number = int(TCS_leave_early.text.split(" ")[0])
        ...
        TCS_vacation_number = int(TCS_vacation.text.split(" ")[0])
